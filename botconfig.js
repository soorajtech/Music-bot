...
module.exports = {
  ...
  Website: process.env.Website || "https://music-bot.soorajsk.repl.co", // Website where it is hosted at includes http or https || Use "0.0.0.0" if you using Heroku || Do not include /api/callback. Just the website url. I.e. "https://foo.bar"
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "e7f9bc24bd1348188b4d8ac09241458b", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "4dd2c9a7dc6e4d9fadeff11865a75a76", // Spotify Client Secret
  },
};
